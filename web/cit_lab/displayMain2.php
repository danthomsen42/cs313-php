...
queue.id, student_name, queue.course_code as queue_course_code, queue.ast_name as queue_ast_name, enter_time, start_time, end_time, comments, classes.course_code as classes_course_code
FROM students
